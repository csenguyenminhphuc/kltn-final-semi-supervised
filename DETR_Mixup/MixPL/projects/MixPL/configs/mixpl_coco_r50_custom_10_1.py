...
detector = dict(
    ...
    backbone=dict(
        ...
        norm_eval=True,
        style='pytorch',
        init_cfg=dict(type='Pretrained', checkpoint='/home/coder/data/trong/KLTN/DETR_Mixup/resnet50-0676ba61.pth')),
    neck=dict(
        type='ChannelMapper',
...
labeled_dataset.ann_file = 'semi_anns/instances_train.1@10.0.json'
unlabeled_dataset.ann_file = 'semi_anns/instances_train.1@10.0-unlabeled.json'
...
# training schedule for 20k iters
train_cfg = dict(
...
default_hooks = dict(
    checkpoint=dict(by_epoch=False, interval=5000,save_best='teacher/coco/bbox_mAP_50',rule='greater', max_keep_ckpts=1))
