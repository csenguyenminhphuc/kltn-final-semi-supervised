...
labeled_dataset.ann_file = 'semi_anns/instances_train.3@40.0.json'
unlabeled_dataset.ann_file = 'semi_anns/instances_train.3@40.0-unlabeled.json'
...
train_cfg = dict(
    type='IterBasedTrainLoop', max_iters=60000, val_interval=10000)
