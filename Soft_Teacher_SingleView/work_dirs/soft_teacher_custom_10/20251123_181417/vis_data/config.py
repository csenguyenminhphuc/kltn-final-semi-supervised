...
labeled_dataset = dict(
    ann_file='semi_anns/instances_train.3@10.0.json',
    backend_args=None,
...
test_evaluator = dict(
    ann_file=
    '/home/coder/data/trong/KLTN/data_drill_2/anno_valid/_annotations_filtered.coco.json',
    backend_args=None,
    format_only=False,
    metric='bbox',
    type='CocoMetric')
    ...
    dataset=dict(
        datasets=[
            dict(
                ...
                type='CocoDataset'),
            dict(
                ann_file='semi_anns/instances_train.3@10.0-unlabeled.json',
                backend_args=None,
                data_prefix=dict(img='train/'),
                data_root='/home/coder/data/trong/KLTN/data_drill_2/',
...
work_dir = './work_dirs/soft_teacher_custom_10'
