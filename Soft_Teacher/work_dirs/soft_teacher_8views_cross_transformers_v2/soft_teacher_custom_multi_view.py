...
color_space = [
    [
        dict(prob=0.6, type='AutoContrast'),
    ],
    [
        dict(prob=0.5, type='Equalize'),
    ],
    [
        dict(level=7, max_mag=1.4, min_mag=0.7, prob=0.8, type='Brightness'),
    ],
    [
        dict(level=7, max_mag=1.5, min_mag=0.7, prob=0.8, type='Contrast'),
    ],
    [
        dict(level=6, max_mag=2.0, min_mag=0.7, prob=0.5, type='Sharpness'),
    ],
    [
        dict(level=5, max_mag=8.0, min_mag=4.0, prob=0.3, type='Posterize'),
    ],
]
custom_hooks = [
...
param_scheduler = [
    dict(
        begin=0, by_epoch=False, end=7000, start_factor=0.01, type='LinearLR'),
    dict(
        begin=7000,
        by_epoch=False,
        end=40000,
