...
labeled_dataset = dict(
    ann_file=
    '/home/coder/data/trong/KLTN/Soft_Teacher/data_drill/semi_anno_multiview/_annotations.coco.labeled.grouped@60.json',
    backend_args=None,
...
model = dict(
    ...
    semi_train_cfg=dict(
        ...
        pseudo_label_initial_score_thr=0.6,
        reg_pseudo_thr=0.02,
        rpn_pseudo_thr=0.5,
        sup_weight=1.0,
        unsup_weight=0.5),
...
train_dataloader = dict(
    ...
    dataset=dict(
        datasets=[
            ...
            dict(
                ann_file=
                '/home/coder/data/trong/KLTN/Soft_Teacher/data_drill/semi_anno_multiview/_annotations.coco.unlabeled.grouped@60.json',
                backend_args=None,
                data_prefix=dict(img='train/'),
                data_root=
                '/home/coder/data/trong/KLTN/Soft_Teacher/data_drill/',
...
work_dir = 'work_dirs/soft_teacher_8views_cross_transformers'
