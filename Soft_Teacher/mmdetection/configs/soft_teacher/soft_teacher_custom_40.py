...
labeled_dataset.ann_file = 'semi_anns/instances_train2017.3@40.0.json'
unlabeled_dataset.ann_file = 'semi_anns/instances_train2017.3@40.0-unlabeled.json'
unlabeled_dataset.data_prefix = dict(img='unlabeled_data1/')
